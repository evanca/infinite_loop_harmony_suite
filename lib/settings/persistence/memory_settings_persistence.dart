...
class MemoryOnlySettingsPersistence implements SettingsPersistence {
  ...
  String playerName = Constants.defaultUserName;

  @override
  Future<void> saveUserId(String userId) async {}

  @override
  Future<String> getUserId() async => '12345';
  ...
  @override
  Future<bool> getIntroSeen() async => false;

  @override
  Future<void> saveIntroSeen() async {}

  @override
  Future<bool> getIncreasedContrast() async => increasedContrast;
